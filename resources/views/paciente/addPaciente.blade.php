...
<div class="container bootstrap snippets bootdey">
    <h1 class="text-primary">REGISTRAR PACIENTE</h1>
    <hr>
    <div class="row">
        <!-- left column -->
        <div class="col-md-3">
        ...
        <div class="col-md-9 personal-info">
            ...
            <form enctype="multipart/form-data" class="form-horizontal" action="{{ route('paciente.store') }}"
                method="POST">
                @csrf
                ...
                <hr>
                <input type="submit" value="Registrar Paciente" class="btn btn-success">
