...
<div class="container">
    ...
    <div class="responsive">
        <div class="gallery">
          ...
          <div class="desc">
            <a class="btn btn-success btn-sm" href="{{ route('visit.downpdf', $document->id) }}">Descargar</a>
            <form action="{{ route('visit.destroypdf', $document->id) }}" method="post" style="display: inline-block">
                @csrf
                @method('delete')
...
<div style="text-align: center">
    <span style="color: red">
        Nota: Es posible Descargar y Eliminar Documentos de la Visita.
    </span>
</div>
@endsection