...
<div class="container">
    <div class="page-header">
        <h1 style="text-align:center; color: red; font-weight: bolder;">MODULO DE RECIBOS</h1>
    </div>
    <div class="container">
            ...
            <div class="col-md-4">
                <div>
                    <a href="{{ route ('recibo.create')}}">
                        ...
                        <h2 style="color: maroon;">Registrar Recibo</h2>
                        <p style="text-align: left;">
                            <span class="fa fa-info-circle"></span>
                            Usted puede registrar toda la información de los recibos realizados.
                        </p>
                        <a href="{{ route ('recibo.create')}}" class="btn btn-success" title="Ir">Registrar</a>
                    </a>
                </div>
            </div>
            @endcan
