...
<div class="container bootstrap snippets bootdey">
    <h1 class="text-primary">REGISTRAR ACTA DIRECTA</h1>
    <hr>
    <div class="row">
        <!-- left column -->
        <div class="col-md-3">
        ...
        <div class="col-md-9 personal-info">
            ...
            <form enctype="multipart/form-data" class="form-horizontal" action="{{ route('actadir.store') }}"
                method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="js-example-basic-single" id="modality_id" name="modality_id" style="width: 100%;">
                          ...
                          @error('modality_id')
                        <small class="text-danger">¡Es necesario seleccionar una Modalidad!</small>
                        @enderror
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="text-align: center">
                    <span style="color: red">
                        Nota: Solo se aceptan registros con Modalidad Directa.
                    </span>
                </div>
                <hr>
