...
<div class="container bootstrap snippets bootdey">
    <h1 class="text-primary">REGISTRAR PERMISSION</h1>
    <hr>
    <div class="row">
        <!-- left column -->
        <div class="col-md-3">
            ...
            <form enctype="multipart/form-data" class="form-horizontal" action="{{ route('permission.store') }}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        @error('name')
                        <small class="text-danger">¡Introduzca  Nombre del permission!</small>
                        @enderror
                    </div>
                </div>
                <div class="form-group">
                ...
                <hr>
                <input type="submit" value="Registrar Permission" class="btn btn-success">
