...
<body class="dark-mode">
    ...
    <div id="control" class="container">
        <div class="row">
            ...
            <h1 class="text-primary">CREAR ODONTOGRAMA</h1>
            <form class="form-horizontal" action="{{ route('odontograma.store') }}"
                method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" name="diagnostico" id="diagnostico" type="text" placeholder="Ejemplo ">
                            @error('diagnostico')
                        <small class="text-danger">¡Introduzca un diagnostico!</small>
                        @enderror
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" name="fechainicio" id="fechainicio"  type="Date" placeholder="ejemplo">
                            @error('fechainicio')
                        <small class="text-danger">¡Introduzca fechainicio!</small>
                        @enderror
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input class="form-control" name="fechafin" id="fechafin"  type="Date" placeholder="ejemplo">
                            @error('fechafin')
                        <small class="text-danger">¡Introduzca fecha fin!</small>
                        @enderror
                    </div>
                </div>
                <div class="form-group" style="text-align: center">
                    <span style="color: red">
                        Nota: el odontograma  debe ser llenado
                    </span>
                </div>
                <hr>
                ...
                <a href="{{ route('odontograma.create') }}" class="btn btn-warning btn-mini">cargar</a>
