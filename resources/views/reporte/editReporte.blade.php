    ...
    <div class="row">
        ...
        <div class="col-md-9 personal-info">
            ...
            <form enctype="multipart/form-data" class="form-horizontal"
                action="{{ route('reporte.update', $reporte->id) }}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="js-example-basic-single" id="pacienteid3" name="pacienteid3" style="width: 100%;">
                            <option value="{{$reporte->pacienteid}}">{{$pacientes}}</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="js-example-basic-single" id="odontologoid3" name="odontologoid3" style="width: 100%;">
                            <option value="{{$reporte->odontologoid}}">{{ $odontologos }}</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="js-example-basic-single" id="odontogramaid3" name="odontogramaid3" style="width: 100%;">
                            <option value="{{ $reporte->odontogramaid }}">{{ $reporte->odontogramaid }}</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select class="js-example-basic-single" id="servicioid3" name="servicioid3" style="width: 100%;">
                            <option value="{{ $reporte->servicioid}}">{{ $servicios }}</option>
