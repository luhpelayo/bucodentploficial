...
@section('content')
<div class="container">
    <h1 class="well" style="text-align:center; color: red; font-weight: bolder;">CONSULTAR DATOS DE MODELOS DE CARTAS
    </h1>
    <div class="col-lg-12 well">
        <div class="row">
            <form action="{{ route('letter.query') }}" method="POST" target="_blank">
                @csrf
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            <label>Código de Carta</label>
                            <input id="letter_code" name="letter_code" type="text" placeholder="ingrese el codigo a buscar"
                                class="form-control">
                        </div>
                        <div class="col-sm-6 form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="letter_name" name="letter_name" type="text"
