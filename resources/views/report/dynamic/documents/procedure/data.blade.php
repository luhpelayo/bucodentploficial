...
@section('content')
<div class="container">
    <h1 class="well" style="text-align:center; color: red; font-weight: bolder;">CONSULTAR DATOS DE PROCEDIMIENTOS
    </h1>
    <div class="col-lg-12 well">
        <div class="row">
            <form action="{{ route('procedure.query') }}" method="POST" target="_blank">
                @csrf
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            <label>Código de Procedimiento</label>
                            <input id="procedure_code" name="procedure_code" type="text" placeholder="ingrese el codigo a buscar"
                                class="form-control">
                        </div>
                        <div class="col-sm-6 form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="procedure_name" name="procedure_name" type="text"
                            placeholder="ingrese el nombre del procedimiento a buscar" class="form-control">
                    </div>
