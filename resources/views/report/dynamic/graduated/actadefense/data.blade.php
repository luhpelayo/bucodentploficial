...
@section('content')
<div class="container">
    <h1 class="well" style="text-align:center; color: red; font-weight: bolder;">CONSULTAR DATOS DE LAS ACTAS DE DEFENSA
    </h1>
    <div class="col-lg-12 well">
        <div class="row">
            <form action="{{ route('actadef.query') }}" method="POST" target="_blank">
                @csrf
                <div class="col-sm-12">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input id="note_min" name="note_min" type="text" placeholder="ingrese la nota minima a buscar"
                                class="form-control">
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>Nota Maxima</label>
                            <input id="note_max" name="note_max" type="text" placeholder="ingrese la nota maxima a buscar"
                                class="form-control">
                        </div>
                    </div>
