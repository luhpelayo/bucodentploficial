...
@section('content')
<div class="container">
    <h1 class="well" style="text-align:center; color: red; font-weight: bolder;">CONSULTAR DATOS DE CONVENIOS NACIONALES
    </h1>
    <div class="col-lg-12 well">
        <div class="row">
            <form action="{{ route('national.query') }}" method="POST" target="_blank">
                @csrf
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            <label>Nombre de Organización</label>
                            <input id="national_organization" name="national_organization" type="text"
                                placeholder="ingrese el nombre de organizacion a buscar" class="form-control">
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>Firma en Empresa</label>
                            <input id="national_company" name="national_company" type="text"
                    ...
                    <div class="form-group">
                        ...
                        <input id="national_uagrm" name="national_uagrm" type="text"
                            placeholder="ingrese el nombre de la firma a buscar" class="form-control">
                    </div>
